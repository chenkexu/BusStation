...
package hssychargingpole.xpg.com.baidumapdemo.zxing.camera;
...
public final class CameraManager {
	...
	public Camera openDriver(SurfaceHolder holder) throws IOException {
		...
		Log.i("jason", " CameraManager  openDriver");
		return camera ;
	}
	...
	public void closeDriver() {
		if (camera != null) {
			...
			camera.release();
			camera = null;
			Log.i("jason", " CameraManager  closeDriver");
		}
	}
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int topOffset = (screenResolution.y - height) * 11 /20;
